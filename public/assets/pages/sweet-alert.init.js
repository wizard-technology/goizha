...
!function ($) {
    ...
    SweetAlert.prototype.init = function () {
        ...
        $('#sa-warning').click(function () {
            swal({
                title: 'ئاگاداربە',
                text: "تکایە ئاگاداربە ١ نمرەی تێکڕا ئەدەیت بە گشت ئەو خوێنکارانەی کە نمرەکانیان ٤٩ یە ، ڕازیت بەم کردارە؟",
                type: 'warning',
                showCancelButton: true,
                confirmButtonClass: 'btn btn-success',
                cancelButtonClass: 'btn btn-danger m-l-10',
                confirmButtonText: 'ڕازیم',
        ...
        $('#input-alert').click(function () {
            swal({
                title: 'ئاگاداربە',
                text:'تکایە ئەو بڕە دەرەجەیە داغڵ بکە کە ئەتەوێت وەک قەرار بیدەیتە خوێنکار',
                input: 'number',
                showCancelButton: true,
                confirmButtonText: 'جێبەجێکردن',
                cancelButtonText: 'پاشگەزبوونەوە',
                showLoaderOnConfirm: true,
                confirmButtonClass: 'btn btn-success',
                cancelButtonClass: 'btn btn-danger m-l-10',
