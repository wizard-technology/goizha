...
<div class="row">
    <div class="col-sm-12">
        <div class="page-title-box">
            <h4 class="page-title float-right">تێبینیەکان</h4>
            <div class="btn-group">
            </div>
        </div>
    </div>
        ...
        <div class="card m-b-30">
            <div class="card-body">
                ...
                <div class="row justify-content-end" style="width: 100%">
                    <h2 class="mt-0 header-title font-20">هەموو تێبینیەکان</h2>
                </div>
                <div class="row justify-content-end">
                    <p class="text-muted font-20 mr-4">
                        ئەم خشتەیە تایبەتە بە تێبینیەکان بۆ داغڵکردنی نمرەی خوێنکاران
                    </p>
                </div>
                ...
                <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap"
                    ...
                    <thead>
                        <tr>
                            ...
                            <th style="text-align: right;">تیبینی</th>
                    ...
                    <tr>
                        <th dir="rtl" style="text-align: right;">
                            <div class="input-group">
                                <div class="input-group">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <form action="{{route('report.destroy',$value->id)}}" method="POST">
                                            @csrf
                                            @method("DELETE")
                            ...
                            <div class="modal fade bd-example-modal-form-{{$value->id}}" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog modal-lg">
                                    <form class="modal-content" action="{{route('report.update',$value->id)}}" method="POST">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                <label dir="rtl" class="mr-1 font-18"
                                                    style="text-align:right;float: right; ">تێبینی:</label>
                                                <input type="text" class="form-control font-18" dir="rtl" required
                                                    placeholder="تێبینی" name="report" value="{{$value->r_report}}" />
                                            </div>
                                        </div>
                        ...
                        <th dir="rtl" style="text-align: right;">{{$value->r_report}}</th>
